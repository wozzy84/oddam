    ...
    return (
        ...
        <section className="step-two__section">
            <form className="step-two__form">
                ...
                <h3 className="step-two__title">Podaj liczbę 60l worków,<br/>w które spakowałeś/aś rzeczy:</h3>
               ...
               {error && <p style={{color:"red", position: "absolute", bottom: "-30px" }}>Podaj liczbę worków</p>}  
            </form>
        </section>
        </>
    )
