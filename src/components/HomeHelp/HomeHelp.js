      ...
      <div className="home-help__container">
        ...
        <div className="home-help-min">
          <div className="home-help-min__field">
            ...
            <p className="home-help-min__description">
          ...
          <div className="home-help-min__field">
            <div className="home-help-min__circle">
              ORGANIZACJOM POZARZĄDOWYM
            </div>
            <p className="home-help-min__description">
              Pomagamy również wszelkim organizacjom pozarządowym i
              charytatywnym, które nie są Fundacjami. Są to nasi Partnerzy,
              który zrobią dobry pożytek z rzeczy, które do nich trafią.
            </p>
          </div>
          <div className="home-help-min__field">
        ...
        <div className="home-help__nav">
          <ul className="home-help-list">
            <li
              className="home-help-list__element"
              id="foundations"
              style={activeButton === "foundations" ? style : null}
              onClick={handleClick}
            >
              Fundacjom
            </li>
            <li
              className="home-help-list__element"
              id="organizations"
              style={activeButton === "organizations" ? style : null}
              onClick={handleClick}
            >
              Organizacjom pozarządowym
            </li>
            <li
              className="home-help-list__element"
              id="local"
              style={activeButton === "local" ? style : null}
              onClick={handleClick}
            >
              Lokalnym zbiórkom
            </li>
        ...
        <p className="home-help__description">
