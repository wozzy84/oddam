      ...
      <section className="summary__section">
        <form className="summary__form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="summary-brief__container">
            ...
            <p className="summary-brief__details">
              <span className="shirt-icon"></span>
              {bags} {handleBags(bags)}
              {option.map(e => e.optionDescription + ", ")}{" "}
              {recievers.map(e => e + ", ")}{" "}
            </p>
            <p className="summary-brief__details">
              <span className="circle-icon"> </span>dla lokalizacji:{" "}
              {localization}
            </p>
          </div>
