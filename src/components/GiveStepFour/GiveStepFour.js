    ...
    <>
      <section className="step-four__section">
        <form className="step-four__form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <h3 className="step-four__title">
            Podaj adres oraz termin odbioru
            <br /> rzeczy przez kuriera
          </h3>
            ...
            <div className="step-four__form-column">
              ...
              <div className="step-four__input-group">
                ...
                <input
                  name="street"
                  type="text"
                  defaultValue={controledForm.street}
                  onChange={handleChange}
                  ref={register({ required: true, minLength: { value: 3 } })}
                  style={errors.street ? errorBorder : null}
                ></input>
              </div>
              <div className="step-four__input-group">
                <label>Miasto</label>
                <input
                  name="city"
                  type="text"
                  defaultValue={controledForm.city}
                  onChange={handleChange}
                  ref={register({ required: true, minLength: { value: 2 } })}
                  style={errors.city ? errorBorder : null}
                ></input>
              </div>
              <div className="step-four__input-group">
                ...
                <input
                  name="zipCode"
                  type=""
                  defaultValue={controledForm.zipCode}
                  onChange={handleChange}
                  ref={register({ required: true, minLength: { value: 3 } })}
                  style={errors.zipCode ? errorBorder : null}
                ></input>
              </div>
              <div className="step-four__input-group">
                ...
                <input
                  name="phone"
                  type="number"
                  defaultValue={controledForm.phone}
                  onChange={handleChange}
                  ref={register({ required: true, minLength: { value: 5 } })}
                  style={errors.phone ? errorBorder : null}
                ></input>
              </div>
            </div>
            <div className="step-four__form-column">
              ...
              <div className="step-four__input-group">
                ...
                <input
                  name="recieveHour"
                  type="text"
                  defaultValue={controledForm.recieveHour}
                  onChange={handleChange}
                  placeholder={"HH:MM"}
                  ref={register({
                    required: true,
                  ...
                  style={errors.recieveHour ? errorBorder : null}
                ></input>
              </div>
              <div className="step-four__input-group">
                ...
                <textarea
                  name="remarks"
                  defaultValue={controledForm.remarks}
                  onChange={handleChange}
                  ref={register({ maxLength: { value: 120 } })}
                  style={errors.remarks ? errorBorder : null}
                ></textarea>
              </div>
            </div>
          </div>
